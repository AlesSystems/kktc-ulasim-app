...
export default function SmartRoutesCard({ routes, isLoading, origin, destination }: SmartRoutesCardProps) {
  ...
  return (
    <div className="absolute bottom-4 left-4 right-4 md:left-auto md:right-4 md:top-4 md:bottom-auto z-[1000] w-[calc(100%-2rem)] md:w-[28rem] max-h-[60vh] md:max-h-[80vh] overflow-hidden flex flex-col">
